...
@class NSMutableDictionary, FTSContactMgr, NSString, NSMutableArray, NSTimer;
@protocol ContactsDataLogicDelegate;

@interface ContactsDataLogic : NSObject{//} <IFTSContactMgrExt, IContactMgrExt, PluginUtilExt> {
	...
	NSTimer* m_ProcessOnModifyContactTimer;
}
